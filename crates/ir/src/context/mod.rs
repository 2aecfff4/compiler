...
use crate::{
    context::function_ctx::FunctionContext,
...
impl Context {
    ...
    ///
    pub fn with_function<Func, R>(&mut self, function: Function, func: Func) -> R
    where
        Func: FnOnce(FunctionContext<'_>) -> R,
    {
        let types = &mut self.types;
        let function = self.functions.get_mut(function);
    ...
    pub fn dump_ir(&self, path: &std::path::Path) {
        ...
        //                     )
        //                 }
        //                 crate::instruction::Instruction::Call(Call {
        //                     function,
        //                     arguments,
        //                     dst,
        //                 }) => todo!(),
